...
window.AI_CONCIERGE = (function () {
  ...
  const KNOWLEDGE = {
    es: {
      ...
      acabados: "Los acabados de Amira District integran muros de piedra maya natural de la región, carpintería fina en maderas tropicales autóctonas, cubiertas de cuarzo y granito en cocina, y baños de lujo en mármol con cancelería de cristal templado, garantizando confort térmico y elegancia atemporal.",
      ...
      default: "Amira District Residence es una oportunidad exclusiva de reventa en Planta Baja dentro de Tulum Country Club: 2 recámaras con baño spa, amplia terraza privada con salida directa a la zona garden y albercas del proyecto, finos acabados en piedra maya y maderas tropicales, y vistas al campo de golf PGA Riviera Maya. Precio: $536,000 USD con entrega inmediata."
    },
    en: {
      ...
      acabados: "Amira District's finishes feature authentic regional Mayan stone walls, custom cabinetry in noble tropical hardwoods, quartz and granite kitchen surfaces, and luxury marble bathrooms with tempered glass enclosures for enduring elegance and thermal coolness.",
      ...
      default: "Amira District Residence is a rare turnkey ground-floor resale opportunity inside Tulum Country Club: 2 primary suites with en-suite bathrooms, expansive private terrace opening directly to the resort's garden grounds and swimming pools, fine native hardwoods and Mayan stone, and fairway views of the PGA Riviera Maya golf course for $536,000 USD with immediate delivery."
    },
    fr: {
      ...
      acabados: "Les finitions de Amira District associent pierre maya régionale taillée, boiseries en essences tropicales précieuses, plans de travail en quartz et granito, et salles de bains en marbre avec parois en verre trempé.",
  ...
  async function sendMessage(userText, currentLang = "es") {
    ...
    // Try Gemini API
    try {
      const systemInstruction = `You are the Ultra-Luxury AI Concierge for an exclusive Ground-Floor Resale Residence at Amira District inside Tulum Country Club (Riviera Maya, Mexico).
...
Answer in ${lang.toUpperCase()} with elegance and precision. Always highlight the ground-floor terrace with pool access and immediate delivery.`;
      ...
      console.warn("Using Amira District local luxury knowledge engine:", err);
    }
  ...
  function formatResponseWithCTA(text, lang) {
    ...
    const defaultMsg = {
      es: "Hola, estoy conversando con el Concierge de Amira District sobre la reventa en planta baja y deseo agendar una visita.",
      en: "Hello, I was chatting with the Amira District Concierge regarding the ground-floor resale and would like to schedule a private viewing.",
      fr: "Bonjour, j'échange avec le Concierge Amira District à propos de la revente en rez-de-jardin et souhaite convenir d'une visite."
    };
  ...
  window.AmiraConcierge = instance;
  return instance;
})();
