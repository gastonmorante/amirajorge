...
(function () {
  ...
  const CONFIG = {
    ...
    videoPaths: {
      es: "assets/videos/amira-es.mp4",
      en: "assets/videos/amira-en.mp4",
      fr: "assets/videos/amira-en.mp4"
    }
  };
  ...
  const GALLERY_DATA = Array.from({ length: 40 }, (_, i) => ({
    id: i + 1,
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initLanguage() {
    const saved = localStorage.getItem("amira_lang");
  ...
  function setLanguage(lang, persist = true) {
    currentLang = lang;
    if (persist) {
      localStorage.setItem("amira_lang", lang);
    }
   ...
   * Spanish page (es) -> assets/videos/amira-es.mp4
   * English/French page (en, fr) -> assets/videos/amira-en.mp4
   */
